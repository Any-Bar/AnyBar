...
namespace Flow.Bar.Localization.Shared
{
    public static class Constants
    {
        public const string DefaultNamespace = "Flow.Bar";
        ...
        // Use PublicApi instead of PublicAPI for possible ambiguity with Flow.Bar.Plugin.IPublicAPI
