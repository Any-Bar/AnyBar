...
namespace AnyBar.Localization.Shared
{
    public static class Constants
    {
        public const string DefaultNamespace = "AnyBar";
        ...
        // Use PublicApi instead of PublicAPI for possible ambiguity with AnyBar.Plugin.IPublicAPI
