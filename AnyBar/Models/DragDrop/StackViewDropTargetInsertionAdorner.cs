...
namespace AnyBar.Models.DragDrop;

public class StackViewDropTargetInsertionAdorner(UIElement adornedElement, IDropInfo dropInfo) : DropTargetAdorner(adornedElement, dropInfo)
{
    public new Pen Pen { get; set; } = new Pen(Brushes.Gray, 1);

    static StackViewDropTargetInsertionAdorner()
    {
        // Create the pen in a static constructor and freeze them to improve performance.
    ...
    protected override void OnRender(DrawingContext drawingContext)
    {
        ...
        var showAlwaysDropTargetAdorner = itemContainer == null && WpfDragDrop.GetShowAlwaysDropTargetAdorner(itemParent);
