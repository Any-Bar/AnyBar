...
public class ItemsSourceView(object source) : INotifyCollectionChanged
{
    ...
    internal class CollectionChangedRevoker(ItemsSourceView source, NotifyCollectionChangedEventHandler handler) : EventRevoker<ItemsSourceView, NotifyCollectionChangedEventHandler>(source, handler)
    {
