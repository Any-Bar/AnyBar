...
/// <summary>
/// Public APIs that AnyBar plugins can use.
/// </summary>
public interface IPublicAPI
{
    ...
    /// <summary>
    /// Save all settings, including AnyBar settings and image cache.
    /// </summary>
    ...
    /// If it is invalid, it will show AnyBar app icon.
    /// </param>
    ...
    /// Cache the image or not. Cached image will be stored in cache.
