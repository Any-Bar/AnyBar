...
using AnyBar.Plugin.DateTime.Views;
using iNKORE.UI.WPF.Modern.Controls;

namespace AnyBar.Plugin.DateTime;
...
public class Main : IPlugin, IPluginI18n, ICustomLeftClickMenu, IRightClickMenu, ILeftClick, IRightClick
{
    ...
    {
        return Localize.AnyBarPlugin_DateTime_PluginName();
    }

    public string GetTranslatedPluginDescription()
    {
        return Localize.AnyBarPlugin_DateTime_PluginDescription();
    }
    ...
    public Style GetLeftClickMenuMenuStyle(BarElementContext context)
    {
        ...
        return (Style)Application.Current.Resources["AnyBarPlugin_DateTime_LeftClickMenuStyle"];
    }
    ...
    public IList<MenuItem> GetRightClickMenuItems(BarElementContext context)
    {
        ...
        adjustDateTimeItem.SetResourceReference(HeaderedItemsControl.HeaderProperty, nameof(Localize.AnyBarPlugin_DateTime_RightClickMenu_AdjustDateTime));
    ...
    private void AdjustDateTimeItem_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Context.API.ShowMsgError(Localize.AnyBarPlugin_DateTime_RightClickMenu_FailToOpenDateTime());
