...
using AnyBar.Plugin.Performance.Services;
using AnyBar.Plugin.Performance.Views;

namespace AnyBar.Plugin.Performance;
...
public class Main : IPlugin, IPluginI18n, IDisposable
{
    ...
    {
        return Localize.AnyBarPlugin_Performance_PluginName();
    }

    public string GetTranslatedPluginDescription()
    {
        return Localize.AnyBarPlugin_Performance_PluginDescription();
    }
