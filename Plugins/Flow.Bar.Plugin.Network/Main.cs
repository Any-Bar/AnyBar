...
using Flow.Bar.Plugin.Network.Services;
using Flow.Bar.Plugin.Network.Views;

namespace Flow.Bar.Plugin.Network;
...
public class Main : IPlugin, IPluginI18n, IDisposable
{
    ...
    {
        return Localize.FlowBarPlugin_Network_PluginName();
    }

    public string GetTranslatedPluginDescription()
    {
        return Localize.FlowBarPlugin_Network_PluginDescription();
    }
