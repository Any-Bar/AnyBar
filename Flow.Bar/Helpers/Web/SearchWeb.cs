...
namespace Flow.Bar.Helpers.Web;

public class SearchWeb
{
    private static readonly string ClassName = nameof(SearchWeb);
    ...
    /// </summary>
    public static void OpenInBrowserWindow(string url, string browserPath = "", bool inPrivate = false, string privateArg = "")
    {
        ...
        catch (Win32Exception)
        {
            ...
            {
                App.API.LogError(ClassName, $"Failed to open {url} in browser", e);
            }
        }
        catch (Exception e)
        {
    ...
    /// </summary>
    public static void OpenInBrowserTab(string url, string browserPath = "", bool inPrivate = false, string privateArg = "")
    {
        browserPath = string.IsNullOrEmpty(browserPath) ? GetDefaultBrowserPath() : browserPath;
