...
public partial class SettingsExpanderEx
{
    ...
    public static readonly DependencyProperty CornerRadiusProperty = DependencyProperty.Register(
        nameof(CornerRadius), typeof(CornerRadius), typeof(SettingsExpanderEx), new PropertyMetadata(default(CornerRadius)));
    ...
    public static readonly DependencyProperty IsExpandedProperty = DependencyProperty.Register(
        ...
        typeof(bool),
        typeof(SettingsExpanderEx),
        new PropertyMetadata(defaultValue: false, (d, e) => ((SettingsExpanderEx)d).OnIsExpandedPropertyChanged((bool)e.OldValue, (bool)e.NewValue)));
