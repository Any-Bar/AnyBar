...
/// <summary>
/// AutomationPeer for SettingsExpanderEx
/// </summary>
public class SettingsExpanderExAutomationPeer : FrameworkElementAutomationPeer
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SettingsExpanderEx"/> class.
    /// </summary>
    /// <param name="owner">SettingsExpanderEx</param>
    public SettingsExpanderExAutomationPeer(SettingsExpanderEx owner)
        : base(owner)
    {
    }
    ...
    protected override string GetNameCore()
    {
        ...
        if (Owner is SettingsExpanderEx owner)
        {
