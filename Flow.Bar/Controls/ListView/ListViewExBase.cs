...
{
    static ListViewExBase()
    {
        SelectionModeProperty.OverrideMetadata(typeof(ListViewExBase), new FrameworkPropertyMetadata(OnSelectionModePropertyChanged));
    }
    ...
    {
        ((ListViewExBase)d).UpdateMultiSelectEnabled();
    }
    ...
    public static readonly DependencyProperty HeaderProperty =
        ListViewHelper.HeaderProperty.AddOwner(typeof(ListViewExBase));
    ...
    public static readonly DependencyProperty HeaderTemplateProperty =
        ListViewHelper.HeaderTemplateProperty.AddOwner(typeof(ListViewExBase));
    ...
    public static readonly DependencyProperty FooterProperty =
        ListViewHelper.FooterProperty.AddOwner(typeof(ListViewExBase));
    ...
    public static readonly DependencyProperty FooterTemplateProperty =
        ListViewHelper.FooterTemplateProperty.AddOwner(typeof(ListViewExBase));
    ...
    public event ListViewExItemClickEventHandler? ItemClick;
    ...
    protected override void PrepareContainerForItemOverride(DependencyObject element, object item)
    {
        ...
        if (element is ListViewExBaseItem lvi)
        {
    ...
    internal void NotifyListItemClicked(ListViewExBaseItem item)
    {
        if (IsItemClickEnabled)
        {
            ...
            ItemClick?.Invoke(this, new ListViewExItemClickEventArgs { ClickedItem = clickedItem });
        }
    }
