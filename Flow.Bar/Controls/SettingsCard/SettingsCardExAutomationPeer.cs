...
/// </summary>
/// <remarks>
/// Initializes a new instance of the <see cref="SettingsCardEx"/> class.
/// </remarks>
/// <param name="owner"></param>
public class SettingsCardAutomationPeer(SettingsCardEx owner) : FrameworkElementAutomationPeer(owner)
{
    /// <summary>
    ...
    {
        if (Owner is SettingsCardEx settingsCard && settingsCard.IsClickEnabled)
        {
