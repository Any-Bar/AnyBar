...
public partial class SettingsCardEx
{
    /// <summary>
    ...
    public static readonly DependencyProperty IsClickEnabledProperty = DependencyProperty.Register(
        ...
        typeof(bool),
        typeof(SettingsCardEx),
        new PropertyMetadata(defaultValue: false, (d, e) => ((SettingsCardEx)d).OnIsClickEnabledPropertyChanged((bool)e.OldValue, (bool)e.NewValue)));
    ...
    public static readonly DependencyProperty ContentAlignmentProperty = DependencyProperty.Register(
        ...
        typeof(SettingsCardEx),
        new PropertyMetadata(defaultValue: ContentAlignment.Right, (d, e) => ((SettingsCardEx)d).OnContentAlignmentPropertyChanged((ContentAlignment)e.OldValue, (ContentAlignment)e.NewValue)));
