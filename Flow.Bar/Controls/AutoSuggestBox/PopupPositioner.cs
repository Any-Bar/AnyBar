...
internal class PopupPositioner : DependencyObject, IDisposable
{
    ...
    public PopupPositioner(Popup popup)
    {
        ...
        if (popup.IsOpen)
        {
            OnPopupOpened(null, new EventArgs());
        }
    }
    ...
    public void Dispose()
    {
        ...
        OnPopupClosed(null, new EventArgs());
    }
    ...
    /// </summary>
    internal PlacementMode PlacementInternal => Delegates.GetPlacementInternal.Invoke(_popup);
    ...
    private readonly PopupSecurityHelper _secHelper;
    ...
    private class PopupSecurityHelper
    {
        ...
        internal void SetPopupPos(bool position, int x, int y, bool size, int width, int height)
        {
            ...
            PInvoke.SetWindowPos(Handle, HWND.Null, x, y, width, height, flags);
        }
        ...
        {
            var ct = _window?.CompositionTarget;
            if (ct != null)
            {
                try
                {
        ...
        private HWND Handle =>
            _window != null ? new(_window.Handle) : HWND.Null;
    ...
    private static class Delegates
    {
        ...
        public static Func<Popup, PlacementMode> GetPlacementInternal { get; } = null!;

        public static Func<Popup, bool> GetDropOpposite { get; } = null!;

        public static Func<Popup, PlacementMode, Point[]> GetPlacementTargetInterestPoints { get; } = null!;
        public static Func<Popup, PlacementMode, Point[]> GetChildInterestPoints { get; } = null!;
        public static Func<Popup, Rect, Point, Rect> GetScreenBounds { get; } = null!;
    }
}
